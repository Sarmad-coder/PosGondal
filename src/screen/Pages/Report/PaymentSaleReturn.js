...
const PurchaseReturn = () => {
    ...
    const printInvoice = (sale) => {
      ...
      <body>
        ...
        <tr>
        <td>Customer</td>
         <td>${allCustomer?.find(sup => sup?._id === sale?.customerId)?.name}</td>
        </tr>
            <tr>
              <td>Item</td>
  ...
  `;
    ...
    return (
        <div className="content-section p-3 pt-0">
                        ...
                        <div className="table-responsive mt-3">
                            ...
                            >
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{singleSale?.setDate}</td>
                                        {/* <td>{allSupplier?.find(sup => sup?._id === singleSale?.supplierId)?.name}</td> */}
                                        <td>{allCustomer?.find(sup => sup?._id === singleSale?.customerId)?.name}</td>
                                        <td>{allWarehouse?.find(sup => sup?._id === singleSale?.warehouseId)?.name}</td>
            ...
            <p className='dashboadHeading' >Sale Return Report</p >
                    ...
                    <div className="card">
                        <div className="card-body">
                            ...
                            <div className="table-responsive mt-3">
                                ...
                                <h5 style={{ textAlign: "end", paddingRight: "1rem" }}><span style={{ color: "red", marginRight: "0.6rem" }}>Total Sale Returns:</span>{(dateFilterRes ?? allSaleReturn)?.reduce((acc, item) => {
